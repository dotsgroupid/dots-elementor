	...
	<table class="form-table wpsisac-post-sett-table">
		<tbody>
			<tr valign="top">
				...
				<td>
					<input type="text" id="dots-slider-link" class="large-text dots-slider-link" name="dots_slider_link" value="<?php echo esc_url( $read_more_link ); ?>" /><br/>
					<span class="description">
						<?php esc_html_e( 'Enter read more link. eg. ', 'dots-elementor' ); ?>https://thebikershop.id/v16-plus/
					</span>
				</td>
			</tr>
		</tbody>
