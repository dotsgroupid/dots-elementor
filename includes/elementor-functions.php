...
function dots_elementor_register_widget( $widgets_manager ) {
	...
	require_once DOTS_THEME_DIR . '/includes/elementor/banner-carousel.php';
	...
	$widgets_manager->register( new \Elementor_Banner_Carousel_Widget() );
...
function dots_elementor_widgets_dependencies() {
	...
	wp_register_script( 'dea-banner-carousel-script', DOTS_THEME_URI . 'assets/js/elementor/banner-carousel.js', array( 'elementor-frontend' ), DOTS_THEME_VERSION, true );
